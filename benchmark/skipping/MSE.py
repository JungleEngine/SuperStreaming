...
def append_and_compute_diff_two_images(img1, img2, text, margin=0):
...
if __name__ == '__main__':
    ...
    for i in range(start_indx, end):
        ...
        cv2.imwrite( base_path + "output/" + "{0:.5f}".format(diff) + "__" + time + ".png", result)
        print(diff)
