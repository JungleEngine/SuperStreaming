...
int seek_req;
int seek_flags;
int64_t seek_interval = 10 * 1000000; //seek time = 10 seconds
int64_t seek_pos;
int64_t seek_rel = seek_interval;
...
//                seek_pos = incr + av_gettime() - start_time;
//                if (seek_pos < 0 )
//                    seek_pos =0 ;
//                break;
//            case SDLK_RIGHT:
...
//    ret = open_input_file("rtsp://127.0.0.1:8554/Chernobyl_S1E1.mkv");
//    ret = open_input_file("rtsp://127.0.0.1:8554/omar_mokhtar.mkv");
//    ret = open_input_file("rtsp://127.0.0.1:8554/test.mkv");
...
////  ret = open_input_file("/home/dawod/Videos/bazringosh.mp4");
    ...
    while (true) {
    i++;
//	int64_t t = av_gettime_relative()*-1;
